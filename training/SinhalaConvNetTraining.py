...
trainDir = 'D:/IIT/FYP/Project Materials/Python implementation/SinhalaConvoNet-master/dataset-processed1/train'
testDir = 'D:/IIT/FYP/Project Materials/Python implementation/SinhalaConvoNet-master/dataset-processed1/test'
